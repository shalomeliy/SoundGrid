...
| | |
| --- | --- |
| **בעבודה** | **אין גרסה פתוחה.** `v0.8.0` נסגרה 09/12 — פרטים: [`docs/handoff/v0.8.0.md`](docs/handoff/v0.8.0.md). |
| **branch** | הוראת שלום (09/09): `main` ישירות (`git status` מראה). שיחה זו קיבלה branch נפרד (`claude/wonderful-cori-scf85f`) מהסביבה — אילוץ, לא בחירה. |
| **גרסה נוכחית** | `v0.8.0` (`package.json`) — נסגרה 09/12. |
