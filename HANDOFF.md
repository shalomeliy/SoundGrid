...
| | |
| --- | --- |
| **בעבודה** | **אין גרסה פתוחה.** `v0.6.0` (Sampler / Performance Decks) נסגרה 09/09 — בנק גלובלי של 16 סלוטים, טעינה בגרירה, 3 מצבי נגינה, sync ל-BPM המאסטר, ערוץ מיקסר נפרד, פרסיסטנס+ייצוא/ייבוא. **הקלטה מהמאסטר לא נבנתה** (נדחתה ל-v0.6.1 בכוונה — ר' פרטים). פרטים מלאים: [`docs/handoff/v0.6.0.md`](docs/handoff/v0.6.0.md). |
