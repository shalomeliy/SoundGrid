...
| **הבא בתור** | **v0.4.0 — ניתוח מתמשך + מטא‑דאטה קבועה.** האיפיון ב‑[`ROADMAP.md`](ROADMAP.md). **`v0.4.6` (Mix Assist) מאופיין שם גם‑כן** (5 סקירות מומחים + החלטות משתמש, 02/09) — **חסום מאחורי v0.4.0**, לא לדלג אליו לפניה; ‏v0.3.0 כבר סגורה (למעלה) |
