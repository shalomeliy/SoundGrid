...
| | |
| --- | --- |
| **בעבודה** | **אין גרסה פתוחה.** `v0.7.5` (הקלטה מאוחדת — סאמפלר+מאסטר) נסגרה 09/11 — הקלטת סלוט חיה (שורדת רענון), הקלטת מאסטר ל-WAV עם תקרת זיכרון וחיתוך לפי טראק. שני באגים אמיתיים נמצאו ותוקנו: פרסיסטנס מתועכב (400ms) שהיה יכול ליתם הקלטה אם הטאב נסגר, ומונה זמן שהראה "-1:-1" ברגע הראשון. פרטים מלאים: [`docs/handoff/v0.7.5.md`](docs/handoff/v0.7.5.md). |
