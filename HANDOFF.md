...
- **בעבודה:** `v0.2.0 — Jog wheels & scratching` — **v0.2.0a (מנוע ה‑scratch) הושלם**, v0.2.0b (פלטר/ג'וג) הבא
...
- **הבא בתור:** v0.2.0b — הפלטר הגריר, מצב ויניל, עצירת ויניל, ופיצול הג'וג ב‑MIDI
