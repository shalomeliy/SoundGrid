...
| | |
| --- | --- |
| **בעבודה** | **שום גרסה כרגע.** `v0.4.9` (לחיצה על פאד "Mix in" שמור מפעילה מעבר אוטומטי מלא, לא רק קפיצה) נסגרה 05/09 — התכולה המלאה ומה שנמדד ב‑[`docs/handoff/v0.4.9.md`](docs/handoff/v0.4.9.md). ביקוש ישיר של שלום אחרי בדיקת v0.4.7 בפועל. **הבא בתור: סבב איפיון לדיוק/מהירות הסנכרון האוטומטי** (החוב הפתוח מ‑v0.4.6, ר' "חובות טכניים ידועים" למטה) — שלום ביקש אותו במפורש (05/09), לפני `v0.5.0`. |
...
| **גרסה נוכחית** | `v0.4.9` (`package.json`). |
...
| **הבא בתור** | לפתוח סבב איפיון לדיוק הסנכרון האוטומטי (מוצר/ארכיטקטורה/QA) לפני קוד — ר' `ROADMAP.md`. `v0.5.0` (Pad Modes) אחריו. |
