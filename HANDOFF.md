...
| | |
| --- | --- |
| **בעבודה** | **שום דבר כרגע.** v0.3.1 נסגרה (03/09) — ר' [`docs/handoff/v0.3.1.md`](docs/handoff/v0.3.1.md). v0.4.0 נסגרה קודם (03/09) — ר' [`docs/handoff/v0.4.0.md`](docs/handoff/v0.4.0.md). |
...
| **הבא בתור** | לפי `ROADMAP.md`: `v0.4.5` (סימון "השיר הבא") ו‑`v0.4.6` (Mix Assist — תלוי גם ב‑v0.3.0, שכבר סגורה) פתוחים. הבחירה של המשתמש, לא הנחה מראש |
