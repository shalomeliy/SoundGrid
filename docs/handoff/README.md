...
| 2026-08-29 | v0.2.1 ✅ | `vitest` נכנס לריפו; `HANDOFF.md` פוצל (43,916→13,128 בייטים, ‎-70%) והגרסאות הסגורות עברו לכאן; חמישה אינווריאנטים ב‑`tests/repo/` — כל אחד הוכח נופל בלי התיקון שלו. הבדיקות תפסו בהרצה הראשונה קישור שבור ב‑`README.md`, שלוש תיקיות מתות במפת הארכיטקטורה, ונתיב מת נוסף בארכיון v0.1.7 | — |
