...
| v0.2.0 | Jog wheels & scratching | 🔶 v0.2.0a (מנוע) ✅ · v0.2.0b (פלטר/ג'וג) ✅ נכתב · הנפילה חזרה אומתה בהכשלה מכוונת ✅ · **נותר: בדיקה מול FLX4 ומול העכבר** |
| v0.2.1 | **פיצול המסמכים + אינווריאנטים ברמת הריפו** — `vitest` נכנס, `HANDOFF.md` ‎-70% | ✅ (2026-08-29) |
...
## v0.2.1 — פיצול המסמכים + אינווריאנטים ברמת הריפו ✅
**מטרה:** שהמסמכים שמנהלים את הפרויקט ייבדקו כמו קוד, במקום להיסמך על משמעת.
...
- **חמישה אינווריאנטים ב‑`tests/repo/`** — תקציב גודל, גרסה מסונכרנת בין
  ...
  ה‑CLAUDE שזזים באותו commit. **כל אחד מהם באג שקרה בפועל בפרויקט הזה.**
- **הושלם כאשר:** כל בדיקה הוכחה נופלת בלי התיקון שלה, `npm run check` ירוק,
  ו‑`HANDOFF.md` מתחת לתקציב. פירוט מלא: [`docs/handoff/v0.2.1.md`](docs/handoff/v0.2.1.md).
